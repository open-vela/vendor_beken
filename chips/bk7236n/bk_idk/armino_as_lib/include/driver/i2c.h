...
/**
 * @brief     I2C set no ack mode
 *
 * @param id I2C id
 * @param enable enable master write data without slave address no ack mode
 *
 * @return
 *    - BK_OK: succeed
 *    - BK_ERR_I2C_NOT_INIT: I2C driver not init
...
/**
 * @brief     bk_i2c_queue_callback
 *
 * This API set queue call back
 *
 * @return
*/
void bk_i2c_queue_callback(int id, beken_queue_t *queue, void *data);
