...
/**
 * @brief  Convert AON RTC tick to us
 *
 * @tick: AON RTC tick
 *
 * @return
 *    - AON RTC tick to us
 */
uint64_t bk_aon_rtc_tick_to_us(uint64_t tick);

/**
 * @brief  Convert AON RTC us to tick
 *
 * @us: AON RTC us
 *
 * @return
 *    - AON RTC us to tick
 */
uint64_t bk_aon_rtc_us_to_tick(uint64_t us);
 ...
 *
 */
void bk_rtc_reset_counter(aon_rtc_id_t id);
