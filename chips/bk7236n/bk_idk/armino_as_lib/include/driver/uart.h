 ...
 *    - others: other errors.
 */
bk_err_t bk_uart_hal_flush_fifo(uart_id_t id);

/**
 * @brief     Is tx interrupt triggered
 *
 * @param id UART id
 *
 * @return
 ...
 *    - others: other errors.
 */
bool bk_uart_is_tx_interreupt_tirggered(uart_id_t uart_id,uint32_t status);

/**
 * @brief     Is rx interrupt triggered
 *
 * @param id UART id
 *
 * @return
 ...
 *    - others: other errors.
 */
bool bk_uart_is_rx_interreupt_tirggered(uart_id_t uart_id,uint32_t status);

/**
 * @brief    Is tx fifo empty
 *
 * @param id UART id
 *
 * @return
 ...
 *    - others: other errors.
 */
bool bk_uart_is_tx_fifo_empty(uart_id_t id);
 ...
 *    - others: other errors.
 */
uint32_t bk_uart_get_interrupt_status(uart_id_t uart_id);

/**
 * @brief    get int enable status
 *
 * @param id UART id
 *
 * @return
 ...
 *    - others: other errors.
 */
uint32_t bk_uart_get_int_enable_status(uart_id_t uart_id);
 ...
 *    - others: other errors.
 */
bk_err_t bk_uart_clear_interrupt_status(uart_id_t id, uint32_t int_status);

/**
 * @brief    Is rx fifo ready to read
 *
 * @param id UART id
 *
 * @return
 ...
 *    - others: other errors.
 */
bool bk_uart_read_fifo_is_read(uart_id_t id);
 ...
 *    - others: other errors.
 */
bool bk_uart_is_tx_ready(uart_id_t id);
