...
#if CONFIG_DEEP_LV
#define LOW_POWER_DELAY_TIME_HARDWARE                    (2500) //hardware to bootloader cost 2100us
#define LOW_POWER_EXTERN_32K_HARDWARE                    (2200) //hardware to bootloader cost 2100us
#else
#define LOW_POWER_DELAY_TIME_HARDWARE                    (1100) //hardware to wfi() cost 1000us
#define LOW_POWER_EXTERN_32K_HARDWARE                    (1100) //hardware to wfi() cost 1000us
#endif
...
#define PM_CHIP_ID_MPW_V2                                (0x24C00020)
#define PM_CHIP_ID_MPW_V3                                (0x25730020)
#define PM_CHIP_ID_MP_A                                  (0x26140020)
...
typedef enum
{
	DIAG_DEBUG_BTS0 = 0, // diag_bts[0+:16]={ble_dbg2,ble_dbg3}
	DIAG_DEBUG_BTS1,     // diag_bts[16+:16]={ble_dbg0,ble_dbg1}
	DIAG_DEBUG_BTS2,     // {8'd0,diag_bts[32+:8]}={8'd0,agc_test[7:0]}
	DIAG_DEBUG_MAC,      // diag_mac[0+:16]
	DIAG_DEBUG_MAC1,     // diag_mac[16:16]
	DIAG_DEBUG_PHY,      // diag_mod[0+:16]
	DIAG_DEBUG_PHY1,     // diag_mod[16+:16]
	DIAG_DEBUG_THREAD,   // diag_thread_mux[0+:16]
	DIAG_DEBUG_THREAD1,  // diag_thread_mux[16+:16]
} diag_debug_mux_t;
